 ...
 */
function CustomContentEditController($scope, $routeParams, contentResource) {

    console.log("custom edit controller loaded");
    ...
    console.log("end custom edit");
}

angular.module("umbraco").controller("Umbraco.Editors.Content.CustomEditController", CustomContentEditController);
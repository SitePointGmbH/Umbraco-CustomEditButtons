(function () {
    'use strict';
    function CustomContentEditController($rootScope, $scope, $routeParams, $q, $window, appState, contentResource, entityResource, navigationService, notificationsService, serverValidationManager, contentEditingHelper, localizationService, formHelper, umbRequestHelper, editorState, $http, eventsService, overlayService, $location, localStorageService, treeService, $exceptionHandler) {
        var evts = [];
 ...
 */
        function createButtons(content) {
            ...
            console.log("Content Type: " + content.contentTypeAlias);
 ...
 */
    ...
    function createDirective() {
        var directive = {
            ...
            templateUrl: '/App_Plugins/SP-CustomContentButtons/customEditorSection.html',
            controller: 'Umbraco.Editors.Content.CustomEditorDirectiveController',
            scope: {
                contentId: '=',
                isNew: '=?',
                treeAlias: '@',
    ...
    angular.module('umbraco.directives').controller('Umbraco.Editors.Content.CustomEditorDirectiveController', CustomContentEditController);
    angular.module('umbraco.directives').directive('customContentEditor', createDirective);
}());
